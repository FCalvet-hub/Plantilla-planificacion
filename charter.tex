...
\fechaFINALTrabajo{XX de XXXX de XXXX}	%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en desarrollo de un sistema de control para motores trifásicos sin escobillas y sin sensor hall que pueda hacer girar el motor girar as una velocidad de 100.000 rpm, y tendrá un presupuesto preliminar estimado de 600 h de trabajo y USD4000, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
